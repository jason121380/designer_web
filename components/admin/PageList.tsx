...
export default function PageList({ homeBrandName, pages }: { homeBrandName: string; pages: PageListItem[] }) {
        ...
        <div className={rowClass}>
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-semibold text-gray-900">{homeBrandName}</p>
