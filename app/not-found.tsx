  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 bg-white">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Link
          href="/search"
          className="px-7 py-3 text-sm rounded-lg border border-gray-300 text-gray-700 hover:border-rose-brand hover:text-rose-brand transition-colors"
        >
          搜尋文章
        </Link>
      </div>
